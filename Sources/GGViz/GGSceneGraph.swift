...
extension GGVizContext {
    /// Render to a scenegraph tree. Can be performed on a background queue.
    public func renderToGGSceneGraph<M: Codable & Hashable>(spec: VizSpec<M>, data: [String: [Bric]]? = nil, canvas: CanvasAPI? = nil) throws -> GGSceneGraph {
        let result = try self.renderViz(spec: spec, data: data, returnScenegraph: true, canvas: canvas)

        let resultSG = result[GGVizContext.RenderResponseKey.scenegraph.rawValue]
        return try resultSG.toDecodable(ofType: GGSceneGraph.self)
    }
}
...
///
/// - Generated by [Curio](https://github.com/glimpseio/BricBrac) from: [Vega Scenegraph](https://github.com/vega/vega/tree/master/packages/vega-scenegraph)
public enum GGSceneGraph : Equatable, Hashable, Codable {
    /// An additional key that is included in the JSON output from vega despite being foebidden by the vega-scenegraph schema
    static let clipKey = "clip"

    case markCase(SceneMark)

    public init(_ arg: SceneMark) {
        self = .markCase(arg)
    }
    ...
    public init(from decoder: Decoder) throws {
        var errors: [Error] = []
        do { self = try .markCase(SceneMark(from: decoder)); return } catch { errors.append(error) }
    ...
    /// Generated by Curio
    public enum SceneMark : Equatable, Hashable, Codable {
    ...
    public struct GradientStop : Equatable, Hashable, Codable, KeyedCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            // try decoder.forbidAdditionalProperties(notContainedIn: CodingKeys.allCases, or: [GGSceneGraph.clipKey]) { _, _ in }
        }
    ...
    public struct ItemArc : Equatable, Hashable, Codable, KeyedCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            // manually disabled because getting all the properties in a JXContext is slow
    ...
    public struct ItemGroup : Equatable, Hashable, Codable, KeyedCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.items = try values.decodeOptional([SceneMark].self, forKey: .items)
