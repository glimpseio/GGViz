...
extension VizEngine {
    ...
    public func renderToScenegraph<M: Codable & Hashable>(spec: VizSpec<M>, data: [String: [Bric]]? = nil, canvas: CanvasAPI? = nil) throws -> Scenegraph {
        ...
        let resultSG = result[VizEngine.RenderResponseKey.scenegraph.rawValue]
        return try resultSG.toDecodable(ofType: Scenegraph.self)
    }
}
...
public enum Scenegraph : Pure, Equatable, Hashable, Codable {
    ...
    public struct GradientStop : Equatable, Hashable, Codable, KeyedCodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            // try decoder.forbidAdditionalProperties(notContainedIn: CodingKeys.allCases, or: [Scenegraph.clipKey]) { _, _ in }
        }
